...
export const addStackFrames = createSessionAction<{
  threadId: number;
  stackFrames: StackFrameEntity[];
}>("session/addStackFrames");
export const addScopes = createSessionAction<{ frameId: number; scopes: ScopeEntity[] }>(
  "session/addScopes",
);
export const addVariables = createSessionAction<{ variables: VariablesEntity[] }>(
  "session/addVariables",
);
...
export const updateLastFetch = createAction("session/updateLastFetch", (sessionId: string) => ({
